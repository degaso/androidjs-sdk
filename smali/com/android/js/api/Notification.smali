...
.method public constructor <init>(Landroid/app/Activity;ILjava/lang/String;)V
    ...
    const-string p2, "androidjs.notifications"

    const/4 p3, 0x3

    const-string v0, "androidjs"

    invoke-direct {p1, v0, p2, p3}, Landroid/app/NotificationChannel;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;I)V
...
.method public initNotification(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v2, p0, Lcom/android/js/api/Notification;->activity:Landroid/app/Activity;

    const-string v4, "androidjs"

    invoke-direct {v1, v2, v4}, Landroid/support/v4/app/NotificationCompat$Builder;-><init>(Landroid/content/Context;Ljava/lang/String;)V
