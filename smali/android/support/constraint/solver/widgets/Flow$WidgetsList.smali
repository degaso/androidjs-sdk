...
.method public createConstraints(ZIZ)V
    ...
    :cond_9
    :goto_5
    iget v6, v0, Landroid/support/constraint/solver/widgets/Flow$WidgetsList;->mOrientation:I
    ...
    .line 486
    iget-object v6, v0, Landroid/support/constraint/solver/widgets/Flow$WidgetsList;->biggest:Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    invoke-virtual {v6, v10}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setVerticalChainStyle(I)V
    ...
    .line 494
    iget-object v10, v6, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mBottom:Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    invoke-virtual {v6}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->hasBaseline()Z
    ...
    iget-object v3, v0, Landroid/support/constraint/solver/widgets/Flow$WidgetsList;->mLeft:Landroid/support/constraint/solver/widgets/ConstraintAnchor;

    iget v11, v0, Landroid/support/constraint/solver/widgets/Flow$WidgetsList;->mPaddingLeft:I

    invoke-virtual {v14, v15, v3, v11}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->connect(Landroid/support/constraint/solver/widgets/ConstraintAnchor;Landroid/support/constraint/solver/widgets/ConstraintAnchor;I)V
    ...
    iget-object v11, v9, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mRight:Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    .line 555
    :cond_18
    iget-object v3, v9, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mRight:Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    iget v9, v0, Landroid/support/constraint/solver/widgets/Flow$WidgetsList;->mPaddingRight:I

    invoke-virtual {v3, v9}, Landroid/support/constraint/solver/widgets/ConstraintAnchor;->setGoneMargin(I)V
    ...
    .line 593
    iget-object v6, v0, Landroid/support/constraint/solver/widgets/Flow$WidgetsList;->this$0:Landroid/support/constraint/solver/widgets/Flow;

    invoke-static {v6}, Landroid/support/constraint/solver/widgets/Flow;->access$800(Landroid/support/constraint/solver/widgets/Flow;)I

    move-result v6

    invoke-virtual {v3, v6}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setHorizontalChainStyle(I)V

    .line 594
    iget v6, v0, Landroid/support/constraint/solver/widgets/Flow$WidgetsList;->mPaddingLeft:I
    ...
    invoke-virtual {v10, v11, v6}, Landroid/support/constraint/solver/widgets/ConstraintAnchor;->connect(Landroid/support/constraint/solver/widgets/ConstraintAnchor;I)Z
    ...
    invoke-virtual {v6, v10, v11}, Landroid/support/constraint/solver/widgets/ConstraintAnchor;->connect(Landroid/support/constraint/solver/widgets/ConstraintAnchor;I)Z

    :cond_21
    if-lez p2, :cond_24

    .line 604
    iget-object v6, v0, Landroid/support/constraint/solver/widgets/Flow$WidgetsList;->mRight:Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    invoke-virtual {v6, v10, v2}, Landroid/support/constraint/solver/widgets/ConstraintAnchor;->connect(Landroid/support/constraint/solver/widgets/ConstraintAnchor;I)Z
    ...
    .line 613
    iget-object v6, v0, Landroid/support/constraint/solver/widgets/Flow$WidgetsList;->mLeft:Landroid/support/constraint/solver/widgets/ConstraintAnchor;
...
.method public measureMatchConstraints(I)V
    ...
    .line 701
    iget v0, p0, Landroid/support/constraint/solver/widgets/Flow$WidgetsList;->mStartIndex:I
    ...
    invoke-static {v2}, Landroid/support/constraint/solver/widgets/Flow;->access$400(Landroid/support/constraint/solver/widgets/Flow;)I
    ...
    invoke-static {v0}, Landroid/support/constraint/solver/widgets/Flow;->access$500(Landroid/support/constraint/solver/widgets/Flow;)[Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    .line 707
    iget v0, v3, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mMatchConstraintDefaultWidth:I
    ...
    .line 713
    iget v0, v3, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mMatchConstraintDefaultHeight:I
