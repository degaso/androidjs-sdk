...
.method private load(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .line 107
    :cond_5
    new-instance v0, Landroid/support/constraint/StateSet$Variant;

    invoke-direct {v0, p1, p2}, Landroid/support/constraint/StateSet$Variant;-><init>(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V

    if-eqz v1, :cond_8

    .line 109
    invoke-virtual {v1, v0}, Landroid/support/constraint/StateSet$State;->add(Landroid/support/constraint/StateSet$Variant;)V

    goto :goto_4

    .line 103
    :cond_6
    new-instance v1, Landroid/support/constraint/StateSet$State;

    invoke-direct {v1, p1, p2}, Landroid/support/constraint/StateSet$State;-><init>(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V

    .line 104
    iget-object v0, p0, Landroid/support/constraint/StateSet;->mStateList:Landroid/util/SparseArray;

    iget v3, v1, Landroid/support/constraint/StateSet$State;->mId:I
...
.method public convertToConstraintSet(IIFF)I
    ...
    .line 195
    iget v1, v2, Landroid/support/constraint/StateSet$Variant;->mConstraintID:I
    ...
    .line 202
    iget p1, v1, Landroid/support/constraint/StateSet$Variant;->mConstraintID:I
