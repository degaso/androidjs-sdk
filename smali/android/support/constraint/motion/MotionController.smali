...
.method private getAdjustedPosition(F[F)F
    ...
    .line 893
    iget-object v4, p0, Landroid/support/constraint/motion/MotionController;->mMotionPaths:Ljava/util/ArrayList;
    ...
    .line 900
    iget v5, v6, Landroid/support/constraint/motion/MotionPaths;->time:F
...
.method private getPreCycleDistance()F
    ...
    .line 281
    iget-object v7, v4, Landroid/support/constraint/motion/MotionPaths;->mKeyFrameEasing:Landroid/support/constraint/motion/utils/Easing;

    if-eqz v7, :cond_0

    .line 282
    iget v7, v4, Landroid/support/constraint/motion/MotionPaths;->time:F
    ...
    .line 284
    iget v4, v4, Landroid/support/constraint/motion/MotionPaths;->time:F
    ...
    .line 298
    invoke-virtual {v15, v3, v4}, Landroid/support/constraint/motion/utils/Easing;->get(D)D
    ...
    invoke-virtual {v3, v13, v14, v4}, Landroid/support/constraint/motion/utils/CurveFit;->getPos(D[D)V
    ...
    invoke-virtual {v3, v4, v7, v1, v12}, Landroid/support/constraint/motion/MotionPaths;->getCenter([I[D[FI)V
...
.method buildBounds([FI)V
    ...
    .line 219
    iget v7, v0, Landroid/support/constraint/motion/MotionController;->mStaggerScale:F
    ...
    .line 220
    iget v8, v0, Landroid/support/constraint/motion/MotionController;->mStaggerOffset:F
    ...
    iget-object v10, v10, Landroid/support/constraint/motion/MotionPaths;->mKeyFrameEasing:Landroid/support/constraint/motion/utils/Easing;

    .line 233
    iget-object v11, v0, Landroid/support/constraint/motion/MotionController;->mMotionPaths:Ljava/util/ArrayList;
    ...
    .line 234
    iget-object v14, v13, Landroid/support/constraint/motion/MotionPaths;->mKeyFrameEasing:Landroid/support/constraint/motion/utils/Easing;

    if-eqz v14, :cond_6

    .line 235
    iget v14, v13, Landroid/support/constraint/motion/MotionPaths;->time:F
    ...
    .line 236
    iget-object v9, v13, Landroid/support/constraint/motion/MotionPaths;->mKeyFrameEasing:Landroid/support/constraint/motion/utils/Easing;

    .line 237
    iget v10, v13, Landroid/support/constraint/motion/MotionPaths;->time:F
    ...
    .line 240
    iget v12, v13, Landroid/support/constraint/motion/MotionPaths;->time:F
    ...
    .line 251
    invoke-virtual {v10, v6, v7}, Landroid/support/constraint/motion/utils/Easing;->get(D)D
    ...
    invoke-virtual {v6, v7, v8, v9}, Landroid/support/constraint/motion/utils/CurveFit;->getPos(D[D)V

    .line 257
    iget-object v6, v0, Landroid/support/constraint/motion/MotionController;->mArcSpline:Landroid/support/constraint/motion/utils/CurveFit;
    ...
    iget-object v8, v0, Landroid/support/constraint/motion/MotionController;->mInterpolateData:[D

    mul-int/lit8 v9, v5, 0x2

    move-object/from16 v10, p1

    invoke-virtual {v6, v7, v8, v10, v9}, Landroid/support/constraint/motion/MotionPaths;->getBounds([I[D[FI)V
...
.method buildPath([FI)V
    ...
    .line 144
    iget v13, v0, Landroid/support/constraint/motion/MotionController;->mStaggerOffset:F
    ...
    .line 158
    iget-object v15, v4, Landroid/support/constraint/motion/MotionPaths;->mKeyFrameEasing:Landroid/support/constraint/motion/utils/Easing;

    if-eqz v15, :cond_8

    .line 159
    iget v15, v4, Landroid/support/constraint/motion/MotionPaths;->time:F
    ...
    .line 160
    iget-object v12, v4, Landroid/support/constraint/motion/MotionPaths;->mKeyFrameEasing:Landroid/support/constraint/motion/utils/Easing;
    ...
    .line 175
    invoke-virtual {v12, v9, v10}, Landroid/support/constraint/motion/utils/Easing;->get(D)D
    ...
    .line 180
    :cond_b
    iget-object v4, v0, Landroid/support/constraint/motion/MotionController;->mSpline:[Landroid/support/constraint/motion/utils/CurveFit;

    aget-object v4, v4, v18

    iget-object v12, v0, Landroid/support/constraint/motion/MotionController;->mInterpolateData:[D

    invoke-virtual {v4, v9, v10, v12}, Landroid/support/constraint/motion/utils/CurveFit;->getPos(D[D)V

    .line 181
    iget-object v4, v0, Landroid/support/constraint/motion/MotionController;->mArcSpline:Landroid/support/constraint/motion/utils/CurveFit;
    ...
    invoke-virtual {v4, v9, v10, v1, v12}, Landroid/support/constraint/motion/MotionPaths;->getCenter([I[D[FI)V
...
.method getDpDt(FFF[F)V
    ...
    iget-object p2, p0, Landroid/support/constraint/motion/MotionController;->mStartMotionPath:Landroid/support/constraint/motion/MotionPaths;

    iget p2, p2, Landroid/support/constraint/motion/MotionPaths;->x:F

    sub-float/2addr p1, p2

    .line 1077
    iget-object p2, p0, Landroid/support/constraint/motion/MotionController;->mEndMotionPath:Landroid/support/constraint/motion/MotionPaths;

    iget p2, p2, Landroid/support/constraint/motion/MotionPaths;->y:F

    iget-object p3, p0, Landroid/support/constraint/motion/MotionController;->mStartMotionPath:Landroid/support/constraint/motion/MotionPaths;

    iget p3, p3, Landroid/support/constraint/motion/MotionPaths;->y:F

    sub-float/2addr p2, p3

    .line 1078
    iget-object p3, p0, Landroid/support/constraint/motion/MotionController;->mEndMotionPath:Landroid/support/constraint/motion/MotionPaths;

    iget p3, p3, Landroid/support/constraint/motion/MotionPaths;->width:F

    iget-object p4, p0, Landroid/support/constraint/motion/MotionController;->mStartMotionPath:Landroid/support/constraint/motion/MotionPaths;

    iget p4, p4, Landroid/support/constraint/motion/MotionPaths;->width:F

    sub-float/2addr p3, p4

    .line 1079
    iget-object p4, p0, Landroid/support/constraint/motion/MotionController;->mEndMotionPath:Landroid/support/constraint/motion/MotionPaths;

    iget p4, p4, Landroid/support/constraint/motion/MotionPaths;->height:F
    ...
    iget v0, v0, Landroid/support/constraint/motion/MotionPaths;->height:F
...
.method public getKeyFrameInfo(I[I)I
    ...
    .line 1247
    iget v7, v5, Landroid/support/constraint/motion/Key;->mFramePosition:I
    ...
    .line 1250
    iget-object v7, p0, Landroid/support/constraint/motion/MotionController;->mSpline:[Landroid/support/constraint/motion/utils/CurveFit;
    ...
    invoke-virtual {v7, v8, v9, v6}, Landroid/support/constraint/motion/utils/CurveFit;->getPos(D[D)V

    .line 1251
    iget-object v6, p0, Landroid/support/constraint/motion/MotionController;->mStartMotionPath:Landroid/support/constraint/motion/MotionPaths;

    iget-object v7, p0, Landroid/support/constraint/motion/MotionController;->mInterpolateVariables:[I

    iget-object v8, p0, Landroid/support/constraint/motion/MotionController;->mInterpolateData:[D

    invoke-virtual {v6, v7, v8, v0, v2}, Landroid/support/constraint/motion/MotionPaths;->getCenter([I[D[FI)V
...
.method getPostLayoutDvDp(FIIFF[F)V
    ...
    iget-object v10, v0, Landroid/support/constraint/motion/MotionController;->mInterpolateVelocity:[D

    iget-object v11, v0, Landroid/support/constraint/motion/MotionController;->mInterpolateData:[D
    ...
    invoke-virtual/range {v5 .. v11}, Landroid/support/constraint/motion/MotionPaths;->setDpDt(FF[F[I[D[D)V
    ...
    .line 1129
    invoke-virtual/range {v12 .. v17}, Landroid/support/constraint/motion/utils/VelocityMatrix;->applyTransform(FFII[F)V
    ...
    iget-object v1, v0, Landroid/support/constraint/motion/MotionController;->mInterpolateVariables:[I
    ...
    invoke-virtual/range {v13 .. v19}, Landroid/support/constraint/motion/MotionPaths;->setDpDt(FF[F[I[D[D)V
    ...
    iget v13, v13, Landroid/support/constraint/motion/MotionPaths;->width:F
    ...
    iget v13, v13, Landroid/support/constraint/motion/MotionPaths;->height:F
...
.method interpolate(Landroid/view/View;FJLandroid/support/constraint/motion/KeyCache;)Z
    ...
    .line 932
    invoke-direct {v0, v3, v1}, Landroid/support/constraint/motion/MotionController;->getAdjustedPosition(F[F)F
    ...
    .line 937
    invoke-virtual {v5, v2, v3}, Landroid/support/constraint/motion/SplineSet;->setProperty(Landroid/view/View;F)V

    goto :goto_0

    .line 941
    :cond_0
    iget-object v4, v0, Landroid/support/constraint/motion/MotionController;->mTimeCycleAttributesMap:Ljava/util/HashMap;
    ...
    .line 943
    instance-of v4, v1, Landroid/support/constraint/motion/TimeCycleSplineSet$PathRotate;
    ...
    invoke-virtual {v1, v14, v15, v2}, Landroid/support/constraint/motion/utils/CurveFit;->getPos(D[D)V
    ...
    invoke-virtual {v1, v14, v15, v2}, Landroid/support/constraint/motion/utils/CurveFit;->getSlope(D[D)V
    ...
    invoke-virtual {v4, v14, v15, v5}, Landroid/support/constraint/motion/utils/CurveFit;->getPos(D[F)V

    .line 979
    iget-object v4, v0, Landroid/support/constraint/motion/MotionController;->mStartMotionPath:Landroid/support/constraint/motion/MotionPaths;

    iget-object v4, v4, Landroid/support/constraint/motion/MotionPaths;->attributes:Ljava/util/LinkedHashMap;

    iget-object v5, v0, Landroid/support/constraint/motion/MotionController;->mAttributeNames:[Ljava/lang/String;
    ...
    invoke-virtual {v4, v2, v5}, Landroid/support/constraint/ConstraintAttribute;->setInterpolatedValue(Landroid/view/View;[F)V
    ...
    iget-object v4, v0, Landroid/support/constraint/motion/MotionController;->mStartPoint:Landroid/support/constraint/motion/MotionConstrainedPoint;

    iget v4, v4, Landroid/support/constraint/motion/MotionConstrainedPoint;->visibility:I
    ...
    .line 993
    :goto_8
    iget-object v4, v0, Landroid/support/constraint/motion/MotionController;->mKeyTriggers:[Landroid/support/constraint/motion/KeyTrigger;
    ...
    invoke-virtual {v4, v3, v2}, Landroid/support/constraint/motion/KeyTrigger;->conditionallyFire(FLandroid/view/View;)V
    ...
    iget v4, v4, Landroid/support/constraint/motion/MotionPaths;->x:F

    iget-object v5, v0, Landroid/support/constraint/motion/MotionController;->mStartMotionPath:Landroid/support/constraint/motion/MotionPaths;

    iget v5, v5, Landroid/support/constraint/motion/MotionPaths;->x:F
    ...
    iget v5, v5, Landroid/support/constraint/motion/MotionPaths;->y:F

    iget-object v6, v0, Landroid/support/constraint/motion/MotionController;->mStartMotionPath:Landroid/support/constraint/motion/MotionPaths;

    iget v6, v6, Landroid/support/constraint/motion/MotionPaths;->y:F
    ...
    iget-object v6, v0, Landroid/support/constraint/motion/MotionController;->mEndMotionPath:Landroid/support/constraint/motion/MotionPaths;

    iget v6, v6, Landroid/support/constraint/motion/MotionPaths;->width:F
    ...
    iget v9, v9, Landroid/support/constraint/motion/MotionPaths;->width:F

    iget-object v10, v0, Landroid/support/constraint/motion/MotionController;->mStartMotionPath:Landroid/support/constraint/motion/MotionPaths;

    iget v10, v10, Landroid/support/constraint/motion/MotionPaths;->width:F
    ...
    iget v9, v9, Landroid/support/constraint/motion/MotionPaths;->height:F
    ...
    .line 1030
    instance-of v4, v1, Landroid/support/constraint/motion/KeyCycleOscillator$PathRotateSet;
    ...
    .line 1034
    :cond_10
    invoke-virtual {v1, v2, v3}, Landroid/support/constraint/motion/KeyCycleOscillator;->setProperty(Landroid/view/View;F)V
...
.method public setup(IIFJ)V
    ...
    check-cast v13, Landroid/support/constraint/motion/KeyPosition;
    ...
    .line 506
    iget v8, v13, Landroid/support/constraint/motion/KeyPosition;->mCurveFit:I
    ...
    new-array v6, v4, [Landroid/support/constraint/motion/MotionPaths;
    ...
    iget v1, v0, Landroid/support/constraint/motion/MotionController;->mCurveFitType:I
    ...
    .line 670
    iget-object v11, v0, Landroid/support/constraint/motion/MotionController;->mStartMotionPath:Landroid/support/constraint/motion/MotionPaths;
    ...
    iput-object v1, v0, Landroid/support/constraint/motion/MotionController;->mAttributeNames:[Ljava/lang/String;
    ...
    iput-object v1, v0, Landroid/support/constraint/motion/MotionController;->mAttributeInterpCount:[I
    ...
    .line 683
    iget-object v7, v0, Landroid/support/constraint/motion/MotionController;->mAttributeInterpCount:[I
    ...
    iget v1, v1, Landroid/support/constraint/motion/MotionPaths;->mPathMotionArc:I

    sget v2, Landroid/support/constraint/motion/Key;->UNSET:I
    ...
    iget-object v12, v0, Landroid/support/constraint/motion/MotionController;->mAttributeNames:[Ljava/lang/String;

    invoke-virtual {v9, v11, v2, v12, v1}, Landroid/support/constraint/motion/MotionPaths;->different(Landroid/support/constraint/motion/MotionPaths;[Z[Ljava/lang/String;Z)V
    ...
    iput-object v1, v0, Landroid/support/constraint/motion/MotionController;->mInterpolateVariables:[I
    ...
    iput-object v8, v0, Landroid/support/constraint/motion/MotionController;->mInterpolateData:[D
    ...
    iput-object v1, v0, Landroid/support/constraint/motion/MotionController;->mInterpolateVelocity:[D
    ...
    invoke-virtual {v15, v9}, Landroid/support/constraint/motion/MotionPaths;->hasCustomData(Ljava/lang/String;)Z
    ...
    invoke-virtual {v14, v9}, Landroid/support/constraint/motion/MotionPaths;->getCustomDataCount(Ljava/lang/String;)I
    ...
    invoke-static {v9, v7, v1}, Landroid/support/constraint/motion/utils/CurveFit;->get(I[D[[D)Landroid/support/constraint/motion/utils/CurveFit;
    ...
    .line 769
    :cond_35
    invoke-static {v1, v7, v2}, Landroid/support/constraint/motion/utils/CurveFit;->getArc([I[D[[D)Landroid/support/constraint/motion/utils/CurveFit;
    ...
    iput-object v1, v0, Landroid/support/constraint/motion/MotionController;->mCycleMap:Ljava/util/HashMap;
    ...
    .line 784
    invoke-direct {v0}, Landroid/support/constraint/motion/MotionController;->getPreCycleDistance()F
    ...
    .line 796
    invoke-virtual {v3, v2}, Landroid/support/constraint/motion/KeyCycleOscillator;->setup(F)V
