...
.method private drawPathCartesianTicks(Landroid/graphics/Canvas;FF)V
    ...
    .line 2787
    iget-object v2, v0, Landroid/support/constraint/motion/MotionLayout$DevModeDraw;->mPoints:[F
    ...
    .line 2797
    iget-object v13, v0, Landroid/support/constraint/motion/MotionLayout$DevModeDraw;->mTextPaint:Landroid/graphics/Paint;

    invoke-virtual {v0, v6, v13}, Landroid/support/constraint/motion/MotionLayout$DevModeDraw;->getTextBounds(Ljava/lang/String;Landroid/graphics/Paint;)V
    ...
    .line 2798
    iget-object v14, v0, Landroid/support/constraint/motion/MotionLayout$DevModeDraw;->mBounds:Landroid/graphics/Rect;
    ...
    .line 2799
    iget-object v14, v0, Landroid/support/constraint/motion/MotionLayout$DevModeDraw;->mTextPaint:Landroid/graphics/Paint;
    ...
    invoke-virtual {v0, v2, v3}, Landroid/support/constraint/motion/MotionLayout$DevModeDraw;->getTextBounds(Ljava/lang/String;Landroid/graphics/Paint;)V
...
.method private drawPathScreenTicks(Landroid/graphics/Canvas;FFII)V
    ...
    iget-object v3, p0, Landroid/support/constraint/motion/MotionLayout$DevModeDraw;->this$0:Landroid/support/constraint/motion/MotionLayout;
    ...
    .line 2823
    iget-object v2, p0, Landroid/support/constraint/motion/MotionLayout$DevModeDraw;->mTextPaint:Landroid/graphics/Paint;
    ...
    .line 2824
    iget-object v3, p0, Landroid/support/constraint/motion/MotionLayout$DevModeDraw;->mBounds:Landroid/graphics/Rect;
    ...
    .line 2825
    iget-object v4, p0, Landroid/support/constraint/motion/MotionLayout$DevModeDraw;->mTextPaint:Landroid/graphics/Paint;
    ...
    iget-object v5, p0, Landroid/support/constraint/motion/MotionLayout$DevModeDraw;->mPaintGraph:Landroid/graphics/Paint;
...
.method private drawTicks(Landroid/graphics/Canvas;IILandroid/support/constraint/motion/MotionController;)V
    ...
    .line 2663
    iget-object v2, v7, Landroid/support/constraint/motion/MotionController;->mView:Landroid/view/View;
    ...
    .line 2665
    iget-object v3, v7, Landroid/support/constraint/motion/MotionController;->mView:Landroid/view/View;
    ...
    .line 2668
    iget-object v3, v0, Landroid/support/constraint/motion/MotionLayout$DevModeDraw;->mPathMode:[I
    ...
    .line 2673
    :cond_1
    iget-object v3, v0, Landroid/support/constraint/motion/MotionLayout$DevModeDraw;->mKeyFramePoints:[F
    ...
    .line 2675
    iget-object v3, v0, Landroid/support/constraint/motion/MotionLayout$DevModeDraw;->mPath:Landroid/graphics/Path;
    ...
    .line 2682
    invoke-virtual {v7, v3}, Landroid/support/constraint/motion/MotionController;->getKeyFrame(I)Landroid/support/constraint/motion/MotionPaths;
    ...
    .line 2687
    iget-object v2, v0, Landroid/support/constraint/motion/MotionLayout$DevModeDraw;->mPathMode:[I
    ...
    .line 2688
    invoke-direct {v0, v1, v2, v3}, Landroid/support/constraint/motion/MotionLayout$DevModeDraw;->drawPathRelativeTicks(Landroid/graphics/Canvas;FF)V
    ...
    .line 2690
    invoke-direct {v0, v1, v2, v3}, Landroid/support/constraint/motion/MotionLayout$DevModeDraw;->drawPathCartesianTicks(Landroid/graphics/Canvas;FF)V
    ...
    :cond_4
    :goto_2
    iget-object v2, v0, Landroid/support/constraint/motion/MotionLayout$DevModeDraw;->mPath:Landroid/graphics/Path;

    iget-object v3, v0, Landroid/support/constraint/motion/MotionLayout$DevModeDraw;->mFillPaint:Landroid/graphics/Paint;
    ...
    iget-object v4, v0, Landroid/support/constraint/motion/MotionLayout$DevModeDraw;->mPaintKeyframes:Landroid/graphics/Paint;
...
.method public draw(Landroid/graphics/Canvas;Ljava/util/HashMap;II)V
    ...
    invoke-virtual {v1}, Landroid/support/constraint/motion/MotionLayout;->getHeight()I
