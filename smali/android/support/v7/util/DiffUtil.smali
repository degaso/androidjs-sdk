...
.method public static calculateDiff(Landroid/support/v7/util/DiffUtil$Callback;Z)Landroid/support/v7/util/DiffUtil$DiffResult;
    ...
    check-cast v1, Landroid/support/v7/util/DiffUtil$Range;

    move-object v11, v6

    .line 145
    iget v6, v1, Landroid/support/v7/util/DiffUtil$Range;->oldListStart:I

    iget v7, v1, Landroid/support/v7/util/DiffUtil$Range;->oldListEnd:I

    iget v8, v1, Landroid/support/v7/util/DiffUtil$Range;->newListStart:I

    iget v9, v1, Landroid/support/v7/util/DiffUtil$Range;->newListEnd:I
    ...
    .line 148
    iget v6, p0, Landroid/support/v7/util/DiffUtil$Snake;->size:I
    ...
    .line 152
    :cond_0
    iget v6, p0, Landroid/support/v7/util/DiffUtil$Snake;->x:I

    iget v7, v1, Landroid/support/v7/util/DiffUtil$Range;->oldListStart:I

    add-int/2addr v6, v7

    iput v6, p0, Landroid/support/v7/util/DiffUtil$Snake;->x:I

    .line 153
    iget v6, p0, Landroid/support/v7/util/DiffUtil$Snake;->y:I

    iget v7, v1, Landroid/support/v7/util/DiffUtil$Range;->newListStart:I

    add-int/2addr v6, v7

    iput v6, p0, Landroid/support/v7/util/DiffUtil$Snake;->y:I
    ...
    .line 160
    iget-boolean v7, p0, Landroid/support/v7/util/DiffUtil$Snake;->reverse:Z

    if-eqz v7, :cond_2

    .line 161
    iget v7, p0, Landroid/support/v7/util/DiffUtil$Snake;->x:I

    iput v7, v6, Landroid/support/v7/util/DiffUtil$Range;->oldListEnd:I

    .line 162
    iget v7, p0, Landroid/support/v7/util/DiffUtil$Snake;->y:I
    ...
    .line 164
    :cond_2
    iget-boolean v7, p0, Landroid/support/v7/util/DiffUtil$Snake;->removal:Z
    ...
    .line 177
    iget-boolean v6, p0, Landroid/support/v7/util/DiffUtil$Snake;->reverse:Z

    if-eqz v6, :cond_5

    .line 178
    iget-boolean v6, p0, Landroid/support/v7/util/DiffUtil$Snake;->removal:Z
    ...
    iget v7, p0, Landroid/support/v7/util/DiffUtil$Snake;->size:I

    add-int/2addr v6, v7

    add-int/lit8 v6, v6, 0x1

    iput v6, v1, Landroid/support/v7/util/DiffUtil$Range;->oldListStart:I

    .line 180
    iget v6, p0, Landroid/support/v7/util/DiffUtil$Snake;->y:I

    iget p0, p0, Landroid/support/v7/util/DiffUtil$Snake;->size:I

    add-int/2addr v6, p0

    iput v6, v1, Landroid/support/v7/util/DiffUtil$Range;->newListStart:I
    ...
    .line 196
    sget-object p0, Landroid/support/v7/util/DiffUtil;->SNAKE_COMPARATOR:Ljava/util/Comparator;
...
.method private static diffPartial(Landroid/support/v7/util/DiffUtil$Callback;IIII[I[II)Landroid/support/v7/util/DiffUtil$Snake;
    ...
    .line 233
    invoke-virtual {v0, v5, v10}, Landroid/support/v7/util/DiffUtil$Callback;->areItemsTheSame(II)Z
    ...
    iput v3, v0, Landroid/support/v7/util/DiffUtil$Snake;->size:I
